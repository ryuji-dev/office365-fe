      ...
      <div className="bg-[url('./src/assets/backgrounds/body.png')] flex flex-col w-[90rem] h-[100vh] overflow-y-auto">
        ...
        <div className="flex text-zinc-900 items-start w-full">
          <div className="flex flex-col items-start mt-10 ml-[10rem] gap-2">
            <div className="flex justify-between items-center w-full">
              ...
              <DropdownMenu.Root>
                <DropdownMenu.Trigger asChild>
                  <div className="border-2 border-gray-300 p-1 rounded-lg animate-slide-up cursor-pointer">
                    <Ellipsis />
                  </div>
            ...
            <span
              className={`${statusStyles['접수중']} text-sm rounded-full px-2 py-[0.063rem]`}
            >
              접수중
            </span>
            <p className="text-gray-500 animate-slide-up">
              OOO / 010-1111-1111 / example@example.com / 2025년 2월 19일 13:37
            </p>
            <div className="w-[64rem] h-0.5 bg-gray-300 mt-2" />
          </div>
        </div>
        <div className="flex flex-wrap justify-center w-[64rem] ml-[10rem] ">
          <div className="flex justify-between items-center w-[64rem] h-10 mt-4 px-4 bg-indigo-100 rounded-sm">
            <div className="flex items-center gap-2">
              <MapPinCheckInside />
              엘리스트랙
            </div>
            <div className="flex items-center gap-2">
              <p>2025년 2월 20일 09:00 ~ 2025년 2월 20일 18:00</p>
            </div>
          </div>
