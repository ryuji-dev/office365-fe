...
function Agreement({ type }: AgreementProps) {
  return (
    <div className="mb-4 p-2 border border-gray-300 bg-gray-100 rounded-md h-32 overflow-y-scroll">
      <p className="text-sm text-zinc-850">
        {type === 'terms' ? (
          <>
            제1조 목적
            <br />
            본 이용약관은 "OFFICE 365"(이하 "오피스 365")의 서비스의 이용조건과
            ...
            있으니 회원 스스로 본 이용약관에서 위배되는 게시물은 게재해서는 안
            됩니다.
            <br />
